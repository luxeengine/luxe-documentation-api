---
title: "luxe: system/physics/box_collider3D.modifier"
description: API version 2025.11.1
---
## `luxe: system/physics/box_collider3D.modifier{:lx}` module
...
### BoxCollider3D
`import "luxe: system/physics/box_collider3D.modifier" for BoxCollider3D{:lx}`
> no docs found
...
### Data
`import "luxe: system/physics/box_collider3D.modifier" for Data{:lx}`
> no docs found

- `var body : Link = null{:lx}`
- `var density : Num = 1000{:lx}`
- `var size : Float3 = [1, 1, 1]{:lx}`
...
### System
`import "luxe: system/physics/box_collider3D.modifier" for System{:lx}`
> no docs found
