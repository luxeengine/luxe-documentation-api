---
title: "luxe: system/physics/sphere_collider3D.modifier"
description: API version 2025.11.1
---
## `luxe: system/physics/sphere_collider3D.modifier{:lx}` module
...
### Data
`import "luxe: system/physics/sphere_collider3D.modifier" for Data{:lx}`
> no docs found
...
### SphereCollider3D
`import "luxe: system/physics/sphere_collider3D.modifier" for SphereCollider3D{:lx}`
> no docs found
...
### System
`import "luxe: system/physics/sphere_collider3D.modifier" for System{:lx}`
> no docs found
